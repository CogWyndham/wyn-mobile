 ...
 * @author Cognizant
 */
public class GoogleSearch extends CRAFTTestCase {
	...
	public Object[][] dataTC2() {
		...
		{ "Instance2", ExecutionMode.MOBILE, MobileExecutionPlatform.ANDROID,
				MobileToolName.APPIUM, "", "HJA2JYV8", Browser.CHROME, 1, 1 }, };
	}
}