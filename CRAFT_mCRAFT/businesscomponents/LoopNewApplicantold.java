...
public class LoopNewApplicantold extends ReusableLibrary {
	/**
	...
	public LoopNewApplicantold(ScriptHelper scriptHelper) {
		super(scriptHelper);
	}
	...
	static WebDriverUtil driverUtil = new WebDriverUtil(driver);
	...
	public static void  navigateToStagingURL(String stagingURL) {
	...
	public static void searchAndApplyForRequisition(String jobKeyword, String jobLocation) {
	...
	public static void switchBrowserWindow(String browserTitle) {
